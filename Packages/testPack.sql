...
BEGIN
    SERVICEPACKAGE.ADDSERVICE(
            '987987', 1, '123456789',
            TO_DATE('2024-02-03 13:00:00', 'YYYY-MM-DD HH24:MI:SS'), SYS.ODCINUMBERLIST(1, 3, 6), 2);
END;

BEGIN
    SERVICEPACKAGE.ADDSERVICE('12341234', 2, '987654321',
                              TO_DATE('2024-02-03 8:00:00', 'YYYY-MM-DD HH24:MI:SS'), SYS.ODCINUMBERLIST(1, 3, 6), 1);
END;
...
BEGIN
    SERVICEPACKAGE.ADDSERVICEFORNEARESTDATE('A12345', 1, '123456789', SYS.ODCINUMBERLIST(1, 4, 7, 8));
END;
